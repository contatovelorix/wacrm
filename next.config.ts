...
const nextConfig: NextConfig = {
   ...
   *   - Application documents — private, no-store. Most pages are
   *     authenticated or session-aware, so a default-deny cache policy
   *     prevents a newly added private route from reaching a shared CDN.
   *     Next keeps its own immutable caching for hashed static assets.
   *
